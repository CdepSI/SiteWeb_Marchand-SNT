...
\title{Documentation - Compléter la liste de produits}
...
Cette documentation explique aux élèves comment compléter le fichier \texttt{produits.yaml} en ajoutant de nouveaux produits pour le site web marchand.
